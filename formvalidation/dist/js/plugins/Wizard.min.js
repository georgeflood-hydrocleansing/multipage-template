    ...
    _createClass(i, [
      {
        ...
        value: function install() {
          ...
          this.steps = [].slice.call(
            t.querySelectorAll(this.opts.stepSelector)
          );
          ...
          e(
            this.steps[0],
            _defineProperty({}, this.opts.activeStepClass, true)
          );
            ...
            if (t === 'Valid') {
              ...
              if (_t2 >= _this3.numSteps) {
                ...
                e(
                  ...
                  _defineProperty({}, _this3.opts.activeStepClass, false)
                );
                _this3.currentStep = _t2;
                e(
                  _this3.steps[_this3.currentStep],
                  _defineProperty({}, _this3.opts.activeStepClass, true)
                );
              }
              _this3.onStepActive();
              _this3.onStepValid();
